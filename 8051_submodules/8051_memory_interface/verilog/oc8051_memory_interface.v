...
always @(posedge clk) begin
  if (rst) begin
    ...
    if ((dack_i == 0) && (dstb_o == 0) && ((mem_act == 0) || (mem_act == 2) || (mem_act == 1) || (mem_act == 3)))
      first_time_done <= 1; 
  end
end
assign first_time = (!first_time_done) && ((dack_i == 0) && (dstb_o == 0) && ((mem_act == 0) || (mem_act == 2) || (mem_act == 1) || (mem_act == 3)));
